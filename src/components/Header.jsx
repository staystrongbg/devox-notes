  ...
  return (
    <header className=' lg:flex lg:justify-around lg:items-start lg:flex-row  flex-col items-center justify-center p-4 mt-20'>
      <div className='flex flex-col items-center justify-center lg:justify-end lg:items-end gap-2 '>
        <h1
          className={`main-title text-6xl text-yellow-500 transition-all pointer-events-none ${
        ...
        <button
          title='Add new note'
          disabled={!user && true}
          className={`btn-new bg-[#13aa52] hover:shadow-lg px-2 py-2 rounded-md active:scale-90  text-black  font-medium  transition-all flex items-center justify-center gap-2 z-40 `}
          style={{
